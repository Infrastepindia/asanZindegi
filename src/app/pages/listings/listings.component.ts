...
export class ListingsComponent implements OnInit {
  ...
  all: ListingItem[] = [
    ...
    {
      id: 5,
      title: 'Gray Angelfish',
      category: 'Fish',
      type: 'Sell',
      location: 'Lucknow, India',
      price: 220,
      cover:
        'https://images.unsplash.com/photo-1507057269201-4dce9f9e07b8?q=80&w=1200&auto=format&fit=crop',
      date: '2025-07-18',
      views: 77,
      rating: 4,
    },
    {
      id: 6,
      title: 'Cream Legbar Hybrid',
      category: 'Chickens',
      type: 'Sell',
      location: 'Chennai, India',
      price: 120,
      cover:
        'https://images.unsplash.com/photo-1517451330947-7809dead78d7?q=80&w=1200&auto=format&fit=crop',
      date: '2025-07-20',
      views: 65,
      rating: 5,
    },
    {
      ...
      price: 220,
      cover:
        'https://images.unsplash.com/photo-1519052537406-0f3d2d7c1a2a?q=80&w=1200&auto=format&fit=crop',
      date: '2025-06-28',
      views: 301,
      rating: 5,
    },
